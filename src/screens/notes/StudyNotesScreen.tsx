...
type StudyNotesScreenNavigationProp = NativeStackNavigationProp<MainStackParamList>;

interface StudyNotesScreenProps {
  navigation: StudyNotesScreenNavigationProp;
}
      ...
      {filteredNotes.length === 0 ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <NoteCard
              note={item}
              onPress={() => navigation.navigate('AddEditNote', { noteId: item.id, category: 'study' })}
              onEdit={() => navigation.navigate('AddEditNote', { noteId: item.id, category: 'study' })}
